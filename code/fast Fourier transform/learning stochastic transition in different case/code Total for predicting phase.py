...
dt = 0.01; #steplength
TestLength=400#00 # Number of points for test/validation phase: 0.01 steplength
T2 =36.6+TestLength*dt  # Total time length: including training phase and test/validation phase
...
if __name__ == '__main__':
    ...
    if UseDoubleWell==1:
        NoiseTotal=np.load('../data/fast Fourier transform/NoiseTotal.npy')
        ...
        atrajectory = np.load('../data/fast Fourier transform/actualTrajectory.npy')
