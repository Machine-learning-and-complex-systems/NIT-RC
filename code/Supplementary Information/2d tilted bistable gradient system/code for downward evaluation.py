...
def DoubleWell(para):#Generate dataset
    ...
    #plt.savefig('downxyatra.pdf',bbox_inches = 'tight')
    #plt.show()
...
class Reservoir:
    ...
    def _run(self,WoutPara,Load,Predict):
        ...
        output=[[],[]]
        if Load==0:
            np.save(r'../data/2d tilted bistable gradient system/downxyWinw.npy',self.Win)
            np.save(r'../data/2d tilted bistable gradient system/downxyAw.npy',self.A)
            np.save(r'../data/2d tilted bistable gradient system/downxyWoutParaw.npy',WoutPara)            
            np.save(r'../data/2d tilted bistable gradient system/downxyWb.npy',self.Wb)
            np.save(r'../data/2d tilted bistable gradient system/downxyWxi.npy',self.Wxi)
            np.save(r'../data/2d tilted bistable gradient system/downxyr.npy',self.rFinalTrainTotal)
        else:
            self.Win=np.load(r'../data/2d tilted bistable gradient system/downxyWinw.npy')
            self.A=np.load(r'../data/2d tilted bistable gradient system/downxyAw.npy')
            WoutPara=np.load(r'../data/2d tilted bistable gradient system/downxyWoutParaw.npy')
            self.Wb=np.load(r'../data/2d tilted bistable gradient system/downxyWb.npy')
            self.Wxi=np.load(r'../data/2d tilted bistable gradient system/downxyWxi.npy')
            self.rFinalTrainTotal=np.load(r'../data/2d tilted bistable gradient system/downxyr.npy')
        ...
        for index in range(self.NumBifurPara):
            ...
            if Predict == 0:
                ...
                #plt.savefig('downxyptra.pdf',bbox_inches = 'tight')
                #plt.xlim(-2,2)
                #plt.ylim(-2,2)
                #plt.show()
...
if __name__ == '__main__':
    ...
    if UseDoubleWell==1:
        ...
        for i in range (100):
            ...
            rcpara[0]=1.5   #K_{in}
            rcpara[1]=3.5   #D
            rcpara[2]=3800  #relevant to rho: rho=0.0011
            rcpara[3]=0.64  #alpha
            rcpara[4]=1e-7 #beta
