...
class Reservoir:
    ...
    def _run(self,WoutPara,Load):
        if Load==0:
            np.save(r'../results/Win.npy',self.Win)
            np.save(r'../results/A.npy',self.A)
            np.save(r'../results/WoutPara.npy',WoutPara)
            np.save(r'../results/Wb.npy',self.Wb)
            np.save(r'../results/Wxi.npy',self.Wxi)
            np.save(r'../results/r.npy',self.rFinalTrainTotal)
            
        else:
            self.Win=np.load(r'../data/1d bistable system with colored noise/Win.npy')
            self.A=np.load(r'../data/1d bistable system with colored noise/A.npy')
            WoutPara=np.load(r'../data/1d bistable system with colored noise/WoutPara.npy')
            self.Wb=np.load(r'../data/1d bistable system with colored noise/Wb.npy')
            self.Wxi=np.load(r'../data/1d bistable system with colored noise/Wxi.npy')
            self.rFinalTrainTotal=np.load(r'../data/1d bistable system with colored noise/r.npy')
        ...
        for index in range(self.NumBifurPara):
            ...
            # To save the noise we separated for code 'RC for lorenz noise'
