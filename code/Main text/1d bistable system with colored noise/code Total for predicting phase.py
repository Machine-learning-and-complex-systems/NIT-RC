...
if __name__ == '__main__':
    ...
    if UseDoubleWell==1:
        NoiseTotal=np.load('../data/1d bistable system with colored noise/NoiseTotal.npy')
        ...
        atrajectory = np.load(r'../data/1d bistable system with colored noise/actualTrajectory.npy')
